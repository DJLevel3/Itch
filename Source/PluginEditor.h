...
/**
*/
class ItchAudioProcessorEditor  : public juce::AudioProcessorEditor, public juce::Button::Listener, public juce::ChangeListener
{
public:
    ItchAudioProcessorEditor (ItchAudioProcessor&);
    ~ItchAudioProcessorEditor() override;
...
private:
    ...
    ItchAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ItchAudioProcessorEditor)
};
